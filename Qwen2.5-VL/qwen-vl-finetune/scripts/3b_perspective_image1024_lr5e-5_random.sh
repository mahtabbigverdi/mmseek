...
OUTPUT_DIR="checkpoints/3b_perspective_image1024_10epochs_lr5e5_random"                   # Directory for saving checkpoints
CACHE_DIR="./cache"                          # [TrainingArguments] Cache directory for models
NEW_TOKENS_FILE_PATH="/mmfs1/gscratch/krishna/mahtab/mmseek/Qwen2.5-VL/New_tokens_vqgan_1024.txt"
# ======================
# Model Configuration
# ======================
DATASETS="perspective_image_1024%100"                 # [DataArguments] Dataset with sampling rate
