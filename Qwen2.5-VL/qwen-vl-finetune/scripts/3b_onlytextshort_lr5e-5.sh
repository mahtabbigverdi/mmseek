...
OUTPUT_DIR="checkpoints/3b_onlytextshort_lr5e-5_1epoch"                   # Directory for saving checkpoints
CACHE_DIR="./cache"                          # [TrainingArguments] Cache directory for models
# ======================
# Model Configuration
# ======================
DATASETS="depth_short_aurora%100"                 # [DataArguments] Dataset with sampling rate
