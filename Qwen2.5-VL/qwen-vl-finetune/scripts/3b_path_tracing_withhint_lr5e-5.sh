...
OUTPUT_DIR="checkpoints/3b_path_tracing_2point_withhint_1epoch_lr5e-5_random"                   # Directory for saving checkpoints
CACHE_DIR="./cache"                          # [TrainingArguments] Cache directory for models
# ======================
# Model Configuration
# ======================
DATASETS="pathtacing_withhint_2points_16k%100"                 # [DataArguments] Dataset with sampling rate
