...
OUTPUT_DIR="checkpoints/3b_perspective_image16384_5epochs_lr5e-5_random"                   # Directory for saving checkpoints
CACHE_DIR="./cache"                          # [TrainingArguments] Cache directory for models
NEW_TOKENS_FILE_PATH="/mmfs1/gscratch/krishna/mahtab/mmseek/Qwen2.5-VL/New_tokens_vqgan_16384.txt"
# ======================
# Model Configuration
# ======================
DATASETS="perspective_image_16384%100"                 # [DataArguments] Dataset with sampling rate
