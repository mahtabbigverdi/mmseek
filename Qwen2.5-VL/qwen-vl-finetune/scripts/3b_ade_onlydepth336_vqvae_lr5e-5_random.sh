...
OUTPUT_DIR="checkpoints/3b_ade_depth_only336_vqvae_10epochs_lr2e-4_random"                   # Directory for saving checkpoints
CACHE_DIR="./cache"                          # [TrainingArguments] Cache directory for models
NEW_TOKENS_FILE_PATH="/mmfs1/gscratch/krishna/mahtab/mmseek/Qwen2.5-VL/New_tokens.txt"
# ======================
# Model Configuration
# ======================
DATASETS="ade_depth_only_vqvae%100"                 # [DataArguments] Dataset with sampling rate
