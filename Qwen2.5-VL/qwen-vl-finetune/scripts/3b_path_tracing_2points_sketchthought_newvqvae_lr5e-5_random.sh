...
OUTPUT_DIR="checkpoints/3b_path_tracing_2points_sketchthought_newvqvae_10epochs_lr5e-5_random"                   # Directory for saving checkpoints
CACHE_DIR="./cache"                          # [TrainingArguments] Cache directory for models
NEW_TOKENS_FILE_PATH="/mmfs1/gscratch/krishna/mahtab/mmseek/Qwen2.5-VL/New_tokens.txt"
# ======================
# Model Configuration
# ======================
DATASETS="pathtracing_2points_sketchthought_16k%100"                 # [DataArguments] Dataset with sampling rate
