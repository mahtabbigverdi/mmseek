...
OUTPUT_DIR="checkpoints/3b_onlytextlong_lr5e-5"                   # Directory for saving checkpoints
CACHE_DIR="./cache"                          # [TrainingArguments] Cache directory for models
# ======================
# Model Configuration
# ======================
DATASETS="depth_longtext_aurora%100"                 # [DataArguments] Dataset with sampling rate
