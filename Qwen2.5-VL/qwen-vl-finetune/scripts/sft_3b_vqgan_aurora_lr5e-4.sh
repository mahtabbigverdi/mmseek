...
OUTPUT_DIR="checkpoints/3b_vqgan_aurora_lr5e-4"                   # Directory for saving checkpoints
CACHE_DIR="./cache"                          # [TrainingArguments] Cache directory for models
NEW_TOKENS_FILE_PATH="/mmfs1/gscratch/krishna/mahtab/mmseek/Qwen2.5-VL/New_tokens_vqgan8192.txt"
# ======================
# Model Configuration
# ======================
DATASETS="depth_vqgan_aurora%100"                 # [DataArguments] Dataset with sampling rate
